package com.example.todohw29.Config;

import com.example.todohw29.Service.MyUserDetailsService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        http.csrf().disable()
                ...
                .requestMatchers("/api/v1/user/delete/**" , "/api/v1/todos/todo" ,
                        ...
                        "/api/v1/todos/update/todo/**" , "/api/v1/todos/delete/todo/**").hasAuthority("USER")
